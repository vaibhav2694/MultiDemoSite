			...
			// end 
		    	...
		    	if(!$res1){
                  ...
                  'merchant_id'=>Yii::app()->functions->getMerchantID(),
		    		...
		    		Yii::app()->functions->FoodItemAddBulk($params);
...
'item_name'=>isset($data[0])?$data[0]:"",
'item_description'=>isset($data[2])?$data[2]:'',
'multi_option'=>$final_color_list,
'multi_option_value'=>'',
'require_addon'=>'',
'status'=>($data[3]==1?'publish':'unpublish'),
'category'=>$addon_category_list,
'size'=>$sizeArray,
'price'=>$PriceArray,
'discount'=>isset($data[5])?$data[5]:"0",
'currentController'=> 'merchant',
'addon_item1'=>$addon_item1,
);


$at = Yii::app()->functions->FoodItemAddBulk($params121);
dump($at);
die('ssss');
			    	// code for version 545 start
